	...
	ajaxGet("get",URLMAP.buildingslist,params,function(data){
		...
		if(data.statusCode=="0000"){
			...
			for(var i=0;i<sublist.length;i++){
				...
				var hongbao = '<div class="red_box red_box_top"><p>'+tejia+'</p></div>';
...
//x上限，y下限
				...
				str=
					...
					'<p class="img"><img src="'+HTTPURL+'resource/upload_buildings/'+sublist[i].id+'/top/top.jpg" onerror="/images/one5.png">'+'</p>'+
