...
function shutwzdy() {
	...
	$("#wenzhangdingyue_sj").css('display','none');
}

function wenzhangdingyue_sj() {

	$("#wenzhangdingyue_sj").css('display','block');

}


//最新状态手机端
function wenzhangdingyueSJ(){
	//var data = $("#form1").serializeArray(); //自动将form表单封装成json
	//alert(JSON.stringify(data));
	var jsonuserinfo = $('#wenzhangdingyueSJ').serializeObject();
	//alert(JSON.stringify(jsonuserinfo));
	...
	function showRequest() {
		var jsonuserinfo2 = $('#wenzhangdingyueSJ').serializeObject();
...
function mfth_sj() {
	...
	$("#mianfeitonghua_sj").css('display','block');

}
//最新状态手机端
function mianfeitonghuaSJ(){
	//var data = $("#form1").serializeArray(); //自动将form表单封装成json
	//alert(JSON.stringify(data));
	var jsonuserinfo = $('#mianfeitonghuaSJ').serializeObject();
	//alert(JSON.stringify(jsonuserinfo));
	...
	$('#mianfeitonghuaSJ').ajaxSubmit(options);

	$('#mianfeitonghuaSJ').clearForm();

	function showRequest() {
		var jsonuserinfo2 = $('#mianfeitonghuaSJ').serializeObject();
...
function xidiSJ(){
	//var data = $("#form1").serializeArray(); //自动将form表单封装成json
	//alert(JSON.stringify(data));
	var jsonuserinfo = $('#xidiPC').serializeObject();
	//alert(JSON.stringify(jsonuserinfo));
	...
	$('#xidiPC').ajaxSubmit(options);

	$('#xidiPC').clearForm();

	function showRequest() {
		var jsonuserinfo2 = $('#xidiPC').serializeObject();
