	...
	ajaxGet("get",URLMAP.noticedetail,params,function(data){
		...
		if(data.statusCode=="0000"){
			...
			var adcontent1='<div class="detail_til">'+
				...
				'			  <div id="newsContent" style="width:100%;height:auto;overflow:hidden;font-size: 16px;">	<p style="text-indent:32px;text-autospace:ideograph-numeric;line-height:29px"><span style=";font-family:微软雅黑;font-size:16px">'+data.data.Content +'</span></p>  </div>';
